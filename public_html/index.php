...
<body>
    <main class="page">
        ...
        <section class="branches" aria-label="Выбор филиала Garden Lounge">
            ...
            <article class="branch" data-slider>
                <div class="slider">
                    <div class="slide active"><img src="/admiralteyskaya/couch/uploads/image/kalyannaya-garden-lounge-udelnaya-interer-spb.webp" alt="Кальянная Garden Lounge Удельная, интерьер лаунж-бара на севере Санкт-Петербурга"></div>
                    <div class="slide"><img src="/admiralteyskaya/couch/uploads/image/garden-2.webp" alt="Garden Lounge Удельная зал"></div>
                    <div class="slide"><img src="/admiralteyskaya/couch/uploads/image/safonovleonid_green_55.webp" alt="Garden Lounge Удельная атмосфера"></div>
                    <button class="slider-btn prev" type="button" aria-label="Предыдущее фото">‹</button>
                    <button class="slider-btn next" type="button" aria-label="Следующее фото">›</button>
                </div>
                <div class="branch-body">
