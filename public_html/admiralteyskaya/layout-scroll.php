...
<cms:template title='Прокрутка по меню' executable='0' order='7'>
    ...
    <cms:editable name='scroll_adm_all_mob' label='Общий отступ — мобильный (px)' group='group_scroll_adm' type='text' order='13'>72</cms:editable>
    ...
    <cms:editable name='scroll_adm_philosophy_mob' label='Концепция (#about-us) — мобильный (px)' group='group_scroll_adm' type='text' not_active='scroll_adm_sync_all=1' order='21'>72</cms:editable>
    ...
    <cms:editable name='scroll_adm_experience_mob' label='Интерьер (#photo) — мобильный (px)' group='group_scroll_adm' type='text' not_active='scroll_adm_sync_all=1' order='23'>72</cms:editable>
    ...
    <cms:editable name='scroll_adm_menu_mob' label='Меню (#menu-block) — мобильный (px)' group='group_scroll_adm' type='text' not_active='scroll_adm_sync_all=1' order='25'>72</cms:editable>
    ...
    <cms:editable name='scroll_adm_akzii_mob' label='Акции (#special) — мобильный (px)' group='group_scroll_adm' type='text' not_active='scroll_adm_sync_all=1' order='27'>72</cms:editable>
    ...
    <cms:editable name='scroll_adm_reservation_mob' label='Бронирование (#reservation) — мобильный (px)' group='group_scroll_adm' type='text' not_active='scroll_adm_sync_all=1' order='29'>72</cms:editable>
    ...
    <cms:editable name='scroll_adm_contacts_mob' label='Контакты (#contact) — мобильный (px)' group='group_scroll_adm' type='text' not_active='scroll_adm_sync_all=1' order='31'>72</cms:editable>
    ...
    <cms:editable name='scroll_adm_filial_mob' label='Филиал (#branch-filial) — мобильный (px)' group='group_scroll_adm' type='text' not_active='scroll_adm_sync_all=1' order='33'>72</cms:editable>
    ...
    <cms:editable name='scroll_udel_all_mob' label='Общий отступ — мобильный (px)' group='group_scroll_udel' type='text' order='43'>72</cms:editable>
    ...
    <cms:editable name='scroll_udel_philosophy_mob' label='Концепция (#about-us) — мобильный (px)' group='group_scroll_udel' type='text' not_active='scroll_udel_sync_all=1' order='51'>72</cms:editable>
    ...
    <cms:editable name='scroll_udel_experience_mob' label='Интерьер (#photo) — мобильный (px)' group='group_scroll_udel' type='text' not_active='scroll_udel_sync_all=1' order='53'>72</cms:editable>
    ...
    <cms:editable name='scroll_udel_menu_mob' label='Меню (#menu-block) — мобильный (px)' group='group_scroll_udel' type='text' not_active='scroll_udel_sync_all=1' order='55'>72</cms:editable>
    ...
    <cms:editable name='scroll_udel_akzii_mob' label='Акции (#special) — мобильный (px)' group='group_scroll_udel' type='text' not_active='scroll_udel_sync_all=1' order='57'>72</cms:editable>
    ...
    <cms:editable name='scroll_udel_reservation_mob' label='Бронирование (#reservation) — мобильный (px)' group='group_scroll_udel' type='text' not_active='scroll_udel_sync_all=1' order='59'>72</cms:editable>
    ...
    <cms:editable name='scroll_udel_contacts_mob' label='Контакты (#contact) — мобильный (px)' group='group_scroll_udel' type='text' not_active='scroll_udel_sync_all=1' order='61'>72</cms:editable>
    ...
    <cms:editable name='scroll_udel_filial_mob' label='Филиал (#branch-filial) — мобильный (px)' group='group_scroll_udel' type='text' not_active='scroll_udel_sync_all=1' order='63'>72</cms:editable>
