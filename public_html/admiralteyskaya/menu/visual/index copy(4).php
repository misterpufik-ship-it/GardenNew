...
<head>
    ...
    <style>
        ...
        .image-frame { width: 100%; aspect-ratio: 1/1; border-radius: 8px; overflow: hidden; border: 1px solid rgba(197, 160, 89, 0.2); margin-bottom: 12px; box-shadow: 0 10px 20px rgba(0,0,0,0.5); cursor: pointer; }
        ...
        .btn-base { display: flex; align-items: center; justify-content: center; width: 100%; max-width: 280px; height: 52px; border: 1px solid rgba(197, 160, 89, 0.3); text-transform: uppercase; font-size: 10px; letter-spacing: 0.15em; text-decoration: none; text-align: center; transition: 0.3s; cursor: pointer; }
...
<body class="antialiased">
    ...
    <main class="main-wrapper flex flex-col items-center pb-20">
        ...
        <div id="promos-container" style="display: none; width: 100%;">
            <div class="max-w-[600px] mx-auto px-5">
                <header class="text-center mb-10">
                    ...
                    <div class="w-[160px] h-px bg-gradient-to-r from-transparent via-[#C5A059] to-transparent mx-auto my-4"></div>
                ...
                <div class="space-y-4">
                    <cms:show_repeatable 'list_promos_v2'>
                        <div class="border border-[#C5A059]/20 bg-[#141414]/40 p-5 text-center">
        ...
        <div class="action-area">
            ...
            <a href="https://garden-lounge.pro/admiralteyskaya/menu/text/" class="btn-base"><span class="subtitle-gold">Текстовое меню</span></a>
        </div>
    ...
    <div id="loyalty-modal" onclick="closeLoyaltyModal()">
        <div class="modal-content" onclick="event.stopPropagation()">
            ...
            <a href="https://access.clientomer.ru/feedback/676900-1/" target="_blank" class="modal-btn"><i class="fa-solid fa-wallet"></i> Wallet</a>
            <a href="https://t.me/GardenLounge_Loyalty_Bot" target="_blank" class="modal-btn"><i class="fa-brands fa-telegram"></i> Telegram</a>
        </div>
    </div>
    ...
    <script>
        const menuData = [
            ...
            { cat: 'shisha', title: '<cms:show item_title />', price: '<cms:show item_price />', weight: '<cms:show item_weight />', img: '<cms:show item_img />', desc: '<cms:show item_desc />' },
            </cms:show_repeatable>
            <cms:show_repeatable 'menu_kitchen'>
            { cat: 'kitchen', title: '<cms:show item_title />', price: '<cms:show item_price />', weight: '<cms:show item_weight />', img: '<cms:show item_img />', desc: '<cms:show item_desc />' },
            </cms:show_repeatable>
            <cms:show_repeatable 'menu_bar'>
            { cat: 'bar', title: '<cms:show item_title />', price: '<cms:show item_price />', weight: '<cms:show item_weight />', img: '<cms:show item_img />', desc: '<cms:show item_desc />' },
            </cms:show_repeatable>
            <cms:show_repeatable 'menu_desserts'>
            { cat: 'desserts', title: '<cms:show item_title />', price: '<cms:show item_price />', weight: '<cms:show item_weight />', img: '<cms:show item_img />', desc: '<cms:show item_desc />' },
            </cms:show_repeatable>
        ];
