...
<cms:pages masterpage='menu/text/index.php' limit='1'>
    ...
    <body>
        ...
        <main class="max-w-2xl mx-auto px-4 py-8 pb-24 min-h-screen">
                    ...
                    <div class="content-limiter">
                            ...
                            <cms:show_repeatable 'list_promos_v2'>
                                <div class="promo-card">
                                    <h2 class="font-serif-lux text-2xl text-white italic mb-1">
                                        <cms:if p_title_en><cms:show p_title_en /><cms:else /><cms:show p_title /></cms:if>
                                    </h2>
                                    <p class="text-[12px] text-gray-400 font-light leading-relaxed mb-3 tracking-wide">
                                        <cms:if p_desc_en><cms:show p_desc_en /><cms:else /><cms:show p_desc /></cms:if>
                                    </p>
                                    <div class="w-6 h-px bg-[#C5A059]/30 mx-auto mb-3"></div>
                                    <p class="text-[9px] uppercase tracking-[0.2em] shimmer-gold font-medium">
                                        <cms:if p_tag_en><cms:show p_tag_en /><cms:else /><cms:show p_tag /></cms:if>
                                    </p>
                                </div>
                            </cms:show_repeatable>
                        </div>
                        ...
                        <footer class="mt-8 text-center">
                            <p class="text-[10px] uppercase tracking-[0.3em] font-medium m-0 italic shimmer-gold">
                                <cms:if promo_footer_en><cms:show promo_footer_en /><cms:else /><cms:show promo_footer /></cms:if>
                            </p>
                        </footer>
...
<style>
    ...
    .btn-base {
        ...
        text-decoration: none; text-align: center; box-sizing: border-box; transition: 0.3s;
    }
...
<div class="action-area">
    ...
    <a href="https://t.me/GardenLounge_Loyalty_Bot" target="_blank" class="btn-base btn-gold-fill">
        Loyalty Program
    </a>
