...
<cms:template title='Концепция' name='philosophy_section' executable='0' order='110'>
    ...
    <cms:editable name='phil_group' label='Контент блока' type='group' order='1' />
        ...
        <cms:editable name='phil_seo_h1' label='SEO-заголовок (H1)' group='phil_group' type='text'>Garden Lounge — кальянная и лаунж-бар на севере Санкт-Петербурга</cms:editable>
        ...
        <cms:editable name='phil_slogan' label='Слоган (внизу)' group='phil_group' type='textarea'>Garden Lounge — тайный тропический оазис на севере города, где время замедляется.</cms:editable>
    ...
    <cms:editable name='phil_seo_group' label='SEO и Заточка под ИИ' type='group' order='2' />
        ...
        <cms:editable name='phil_img_alt' label='Alt-текст для разделителя' group='phil_seo_group' type='text'>Эстетичный лаундж бар на Удельной, Санкт-Петербург</cms:editable>

        <cms:editable name='phil_lsi' label='LSI Ключи для ИИ (скрытые)' group='phil_seo_group' type='textarea' desc='Пропишите здесь через запятую важные ключи, которые ИИ должен связать с этим текстом'>кальянная СПб, кальянная Удельная, кальянная у метро Удельная, лаунж бар СПб, кальянная на севере СПб, кальянная с кухней СПб, VIP кальянная СПб, премиальная кальянная, кальянная с PS5, ул. Аккуратова 13</cms:editable>
