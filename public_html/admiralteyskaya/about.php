...
<cms:template title='Концепция' name='philosophy_section' executable='0' order='110'>
    ...
    <cms:editable name='phil_group' label='Контент блока' type='group' order='1' />
        ...
        <cms:editable name='phil_seo_h1' label='SEO-заголовок (H1)' group='phil_group' type='text'>Garden Lounge — кальянная и лаунж-бар в центре Санкт-Петербурга</cms:editable>

        <cms:editable name='phil_content' label='Основной текст описания' group='phil_group' type='richtext'>
            <p>На набережной Мойки, у метро Адмиралтейская, спрятан вечнозелёный сад — эстетичная кальянная, где городская суета остаётся за дверью. Живые тропики, фонтан и камин создают пространство, в котором время замедляется само.</p>
    ...
    <cms:editable name='phil_seo_group' label='SEO и Заточка под ИИ' type='group' order='2' />
        ...
        <cms:editable name='phil_lsi' label='LSI Ключи для ИИ (скрытые)' group='phil_seo_group' type='textarea' desc='Пропишите здесь через запятую важные ключи, которые ИИ должен связать с этим текстом (например: дизайнерская кальянная, центр спб, живые растения)'>кальянная СПб, лаунж бар СПб, кальянная в центре СПб, кальянная Адмиралтейская, кальянная у метро Адмиралтейская, кальянная на Мойке, кальянная с кухней СПб, VIP кальянная СПб, премиальная кальянная, эстетичная кальянная, кальянная с PS5</cms:editable>
