...
<cms:template title='Бронирование Telegram' executable='0' order='5'>
    ...
    <cms:editable name='booking_intro' label='Справка' type='message' order='1'>
        ...
        В тексте сообщения можно использовать переменные: {branch}, {branch_label}, {name}, {phone}, {date}, {time}, {guests}, {source_url}.
    </cms:editable>
    ...
    <cms:editable name='adm_message_template' label='Текст сообщения в Telegram' group='group_admiral_booking' type='textarea' height='180' order='16' desc='Переменные: {branch}, {branch_label}, {name}, {phone}, {date}, {time}, {guests}, {source_url}'>🆕 Новая бронь — {branch_label}
...
🕐 Время: {time}
👥 Гости: {guests}
🌐 Страница: {source_url}</cms:editable>
    ...
    <cms:editable name='udel_message_template' label='Текст сообщения в Telegram' group='group_udelnaya_booking' type='textarea' height='180' order='26' desc='Переменные: {branch}, {branch_label}, {name}, {phone}, {date}, {time}, {guests}, {source_url}'>🆕 Новая бронь — {branch_label}
