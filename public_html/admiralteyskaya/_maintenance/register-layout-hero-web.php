<?php
/**
 * Register layout-hero.php template + fields in CouchCMS DB.
 * https://garden-lounge.pro/admiralteyskaya/_maintenance/register-layout-hero-web.php?key=<md5>
 * key = md5('garden-lounge-register-layout-hero')
 */
$expectedKey = md5('garden-lounge-register-layout-hero');
...
$templateName = 'layout-hero.php';
$title = 'Hero — мобильный лого';
$order = 8;
$cloneFrom = 'layout-scroll.php';
...
$fieldDefs = array(
    array('name' => 'hero_info', 'label' => 'Справка', 'type' => 'message', 'order' => 1),
    array('name' => 'group_hero_adm', 'label' => 'Адмиралтейская', 'type' => 'group', 'order' => 10, 'collapsed' => '1'),
    array('name' => 'hero_adm_logo_down_mob', 'label' => 'Смещение лого вниз — мобильный (px)', 'type' => 'text', 'group' => 'group_hero_adm', 'order' => 11, 'default' => '18'),
    array('name' => 'hero_adm_logo_btn_gap_mob', 'label' => 'Отступ лого до «Забронировать» — мобильный (px)', 'type' => 'text', 'group' => 'group_hero_adm', 'order' => 12, 'default' => '8'),
    array('name' => 'group_hero_udel', 'label' => 'Удельная', 'type' => 'group', 'order' => 20, 'collapsed' => '1'),
    array('name' => 'hero_udel_logo_down_mob', 'label' => 'Смещение лого вниз — мобильный (px)', 'type' => 'text', 'group' => 'group_hero_udel', 'order' => 21, 'default' => '18', 'copy_from' => 'hero_adm_logo_down_mob'),
    array('name' => 'hero_udel_logo_btn_gap_mob', 'label' => 'Отступ лого до «Забронировать» — мобильный (px)', 'type' => 'text', 'group' => 'group_hero_udel', 'order' => 22, 'default' => '8', 'copy_from' => 'hero_adm_logo_btn_gap_mob'),
);
...
echo "Open admin: Общие -> Hero — мобильный лого\n";
