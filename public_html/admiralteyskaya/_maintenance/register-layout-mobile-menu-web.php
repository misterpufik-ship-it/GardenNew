...
$fieldDefs = array(
    ...
    array('name' => 'mm_adm_shell_pad_top', 'label' => 'Отступ сверху до лого (px)', 'type' => 'text', 'group' => 'group_mm_adm', 'order' => 11, 'default' => '32'),
    array('name' => 'mm_adm_logo_menu_gap', 'label' => 'Отступ лого → пункты меню (px)', 'type' => 'text', 'group' => 'group_mm_adm', 'order' => 12, 'default' => '12'),
    array('name' => 'mm_adm_menu_contact_gap', 'label' => 'Отступ меню → блок контактов (px)', 'type' => 'text', 'group' => 'group_mm_adm', 'order' => 13, 'default' => '16'),
    array('name' => 'mm_adm_contact_pad_top', 'label' => 'Пустое место вместо виньетки (px)', 'type' => 'text', 'group' => 'group_mm_adm', 'order' => 14, 'default' => '36'),
    array('name' => 'mm_adm_contact_push', 'label' => 'Опустить контакты ниже (px)', 'type' => 'text', 'group' => 'group_mm_adm', 'order' => 15, 'default' => '8'),
    array('name' => 'mm_adm_social_gap', 'label' => 'Расстояние между иконками соцсетей (px)', 'type' => 'text', 'group' => 'group_mm_adm', 'order' => 16, 'default' => '4'),
    array('name' => 'mm_adm_branch_label', 'label' => 'Пункт «Второй филиал»', 'type' => 'text', 'group' => 'group_mm_adm', 'order' => 17, 'default' => 'ВТОРОЙ ФИЛИАЛ'),
    array('name' => 'group_mm_udel', 'label' => 'Удельная', 'type' => 'group', 'order' => 20, 'collapsed' => '1'),
    array('name' => 'mm_udel_shell_pad_top', 'label' => 'Отступ сверху до лого (px)', 'type' => 'text', 'group' => 'group_mm_udel', 'order' => 21, 'default' => '32', 'copy_from' => 'mm_adm_shell_pad_top'),
    array('name' => 'mm_udel_logo_menu_gap', 'label' => 'Отступ лого → пункты меню (px)', 'type' => 'text', 'group' => 'group_mm_udel', 'order' => 22, 'default' => '12', 'copy_from' => 'mm_adm_logo_menu_gap'),
    array('name' => 'mm_udel_menu_contact_gap', 'label' => 'Отступ меню → блок контактов (px)', 'type' => 'text', 'group' => 'group_mm_udel', 'order' => 23, 'default' => '16', 'copy_from' => 'mm_adm_menu_contact_gap'),
    array('name' => 'mm_udel_contact_pad_top', 'label' => 'Пустое место вместо виньетки (px)', 'type' => 'text', 'group' => 'group_mm_udel', 'order' => 24, 'default' => '36', 'copy_from' => 'mm_adm_contact_pad_top'),
    array('name' => 'mm_udel_contact_push', 'label' => 'Опустить контакты ниже (px)', 'type' => 'text', 'group' => 'group_mm_udel', 'order' => 25, 'default' => '8', 'copy_from' => 'mm_adm_contact_push'),
    array('name' => 'mm_udel_social_gap', 'label' => 'Расстояние между иконками соцсетей (px)', 'type' => 'text', 'group' => 'group_mm_udel', 'order' => 26, 'default' => '4', 'copy_from' => 'mm_adm_social_gap'),
    array('name' => 'mm_udel_branch_label', 'label' => 'Пункт «Второй филиал»', 'type' => 'text', 'group' => 'group_mm_udel', 'order' => 27, 'default' => 'ВТОРОЙ ФИЛИАЛ', 'copy_from' => 'mm_adm_branch_label'),
);
