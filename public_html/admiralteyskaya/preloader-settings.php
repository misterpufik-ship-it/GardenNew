...
<cms:template title='Прелоадер' executable='0' order='3'>
    ...
    <cms:editable name='preloader_video_desktop' label='Видео для десктопа' group='group_preloader_desktop' type='text' order='31' desc='Путь от корня или полный URL. Пусто — общее видео выше.'>/video/preloader.mp4</cms:editable>
