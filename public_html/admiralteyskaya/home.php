...
<cms:template title='Главная' name='home_section' executable='0' order='1'>
    ...
    <cms:editable name='home_seo_desc' label='Описание (Description)' group='group_seo' type='textarea' order='12'>Garden Lounge — лаунж-пространство: кальянный бар на Адмиралтейской или Удельной. Бронирование, меню, бар, VIP-комнаты, PS5 и кухня в центре города.</cms:editable>
