...
<cms:template title='Управление: Шапка (Header)' name='header_section' executable='0' order='10'>
    ...
    <cms:editable name='hero_bg_desk' label='Фон (Десктоп)' group='group_hero' type='image'>https://misterpufik.ru/garden.jpg</cms:editable>
    <cms:editable name='hero_bg_mob' label='Фон (Мобилка)' group='group_hero' type='image'>https://misterpufik.ru/log4.jpg</cms:editable>
