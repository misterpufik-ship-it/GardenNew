...
<head>
    ...
    <style>
        ...
        /* ШАПКА КАК В ТЕКСТОВОЙ ВЕРСИИ */
        .logo-container { padding: 2rem 0; text-align: center; background: #000; }
        .main-logo { height: 7rem; width: auto; margin: 0 auto; } /* h-28 = 7rem = 112px */

        /* НАВИГАЦИЯ КАК В ТЕКСТОВОЙ ВЕРСИИ */
        .nav-sticky { 
        ...
        .nav-item {
            ...
            color: #888; cursor: pointer; transition: 0.3s; padding-bottom: 6px; position: relative;
        }
        ...
        /* СЕТКА БЛЮД */
        .menu-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px; width: 100%; }
        @media (min-width: 768px) { .menu-grid { grid-template-columns: repeat(4, 1fr); gap: 30px; } }

        .image-frame {
            width: 100%; aspect-ratio: 1/1; border-radius: 8px; overflow: hidden;
            border: 1px solid rgba(197, 160, 89, 0.2); margin-bottom: 12px;
        ...
        .dish-title { 
            ...
            letter-spacing: 0.05em; margin-bottom: 6px; text-align: center;
        ...
        .price { font-size: 1.1rem; font-weight: 600; color: #fff; } /* Ближе к тексту */
        .weight { font-size: 11px; color: #777; font-weight: 400; font-style: italic; }

        .details-trigger { 
            font-size: 10px; text-transform: uppercase; color: #8e7037; 
            letter-spacing: 0.15em; cursor: pointer; opacity: 0.8; text-align: center; 
        }

        .details-content { 
            font-size: 12px; color: #A0A0A0; 
            line-height: 1.4; font-weight: 300; margin-top: 10px; 
            display: none; text-align: center; padding: 0 5px;
        }
        .details-content.is-open { display: block; animation: fadeIn 0.3s ease; }

        @keyframes fadeIn { from { opacity: 0; } to { opacity: 1; } }

        /* КНОПКИ КАК В ТЕКСТОВОЙ ВЕРСИИ */
        ...
        .btn-base {
            ...
            text-decoration: none; text-align: center; transition: 0.3s; cursor: pointer;
        }
        ...
        .btn-gold-fill:hover { background: #d4b475; }
        ...
        .modal-content {
            ...
            padding: 40px 25px; width: 100%; max-width: 400px;
        ...
        .modal-btn {
            ...
            width: 100%; height: 54px; border: 1px solid rgba(197,160,89,0.3);
